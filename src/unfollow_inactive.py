...
args = argparse.ArgumentParser(description="Provide links to people you follow but which have been inactive since 2020")
...
while True:
    ...
    for user in tqdm.tqdm(response["users"]):
        # get relationship
        relationship = t.friendships.show(target_id=user["id"], source_id=args.id)["relationship"]
